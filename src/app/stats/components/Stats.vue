  ...
  <div class="container container--centered">
    <div class="stats" v-if="stats">
     ...
     <dl class="dlist">
        ...
        <dd class="dlist__body">{{ stats.shortened_url }}</dd>
     </dl>
     <dl class="dlist">
     ...
     <dl class="dlist">
        ...
        <dd class="dlist__body">{{ stats.last_requested }} {{ pluralize('time', stats.last_requested) }}</dd>
     </dl>
     <dl class="dlist">
        <dt class="dlist__title">Last used</dt>
        <dd class="dlist__body">{{ stats.last_requested || 'Never' }}</dd>
     </dl>

     <a :href="stats.shortened_url" class="button button--yellow">Take me there</a>
    </div>
    <div class="stats__loading">One moment</div>
  </div>
</template>
